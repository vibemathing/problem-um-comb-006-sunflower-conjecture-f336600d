...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-comb-006-sunflower-conjecture-f336600d-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/COMB-006"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-comb-006-sunflower-conjecture-f336600d-v1",
      "problem_contract_sha256": "3c91e7778452e24992d1b09a207250bc3cad26e23dbce577e222f9280ee7ea79",
      "problem_id": "problem:um-comb-006-sunflower-conjecture-f336600d",
      "route_id": "route:um-comb-006-sunflower-conjecture-f336600d-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-comb-006-sunflower-conjecture-f336600d-source-fidelity-01",
      "graph_id": "graph:um-comb-006-sunflower-conjecture-f336600d-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-comb-006-sunflower-conjecture-f336600d-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-comb-006-sunflower-conjecture-f336600d-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "For fixed $r$, can the number of size-$k$ sets needed for an $r$-sunflower be bounded by $c^k$ for some constant $c$?"
          },
          "statement_sha256": "48f503cdb5f05217a99c7e290aad086c01b45fd50dcc3a11afde652b5b604a16"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-comb-006-sunflower-conjecture-f336600d-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-comb-006-sunflower-conjecture-f336600d-root",
      "route_id": "route:um-comb-006-sunflower-conjecture-f336600d-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-comb-006-59543abcd4f3",
        "url": "https://www.unsolvedmath.com/problems/COMB-006"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
